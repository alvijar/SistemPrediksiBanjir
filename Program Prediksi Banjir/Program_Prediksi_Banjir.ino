...
//firebase
#define firebase_host "sistem-prediksi-banjir1-default-rtdb.firebaseio.com/"
#define firebase_auth "FxCVk9EP2ff44M2ainEZTXHetqyk32AjEfKhb8tb"
//chatbot Tele
String ssid = "Sudarto";     // Sesuikan dengan nama wifi anda
String pass = "sudarto123"; // sesuaikan password wifi
...
void chatTeleBanjir(){
  ...
  String a = String (air);
  String w = String (wkt);
  myBot.sendMessage(id, "Kondisi Sungai BANJIR!!! Hati-hati saat berungsi!!!");
  myBot.sendMessage(id, "Ketinggian Air : " + t + " Centimeters\n"
                       +"Debit Air : " + a + " Liter/Menit\n"
